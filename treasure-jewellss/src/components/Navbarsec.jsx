...
//   <div className="w-full max-w-7xl flex items-center justify-between px-6 md:px-10 py-2 
...
//           <Link to="/" className="hover:text-[#B76E79] transition">Home</Link>
//           <Link to="/collections" className="hover:text-[#B76E79] transition">Collections</Link>
//           <Link to="/gifting" className="hover:text-[#B76E79] transition">Gifting</Link>
//           <Link to="/best-sellers" className="hover:text-[#B76E79] transition">Best Sellers</Link>
//           <Link to="/about" className="hover:text-[#B76E79] transition">About Us</Link>
//           <Link to="/contact" className="hover:text-[#B76E79] transition">Contact Us</Link>
...
//           <Link to="/account" className="hover:text-[#B76E79] transition hidden md:block">
//             <FiUser />
//           </Link>

//           <Link to="/cart" className="hover:text-[#B76E79] transition">
//             <FiShoppingBag />
//           </Link>
...
//       {/* Mobile Menu */}
//       {menuOpen && (
//         <div className="lg:hidden flex flex-col gap-6 px-6 py-8 
//         backdrop-blur-lg bg-white/40 border-t border-white/20
//         text-[#4A3428] font-medium shadow-lg">
...
//           <Link to="/best-sellers" onClick={() => setMenuOpen(false)}>Best Sellers</Link>
